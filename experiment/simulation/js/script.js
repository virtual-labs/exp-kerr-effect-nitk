...
function displayDiv(ele) {
  ...
  if (ele.classList.contains("tool-practice")) {
    ...
    // Check if "observation" button is clicked
    document
      .querySelector("#observationbutton")
    ...
    // Hide the "IBobservation" div if any other button is clicked
    document.getElementById("IBobservation").style.display = "none";
  }
...
function lineargraph() {
  ...
  var trace1 = {
    ...
    y: [
      9, 12.25, 16, 20.25, 25, 30.25, 36, 42.25, 49, 56.25, 64, 72.25, 81,
      90.25, 10,
    ],
    mode: "markers",
  };
